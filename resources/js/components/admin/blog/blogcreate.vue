    ...
    <div>
        <nav>
            ...
            <div class="nk-block nk-block-lg">
                ...
                <form enctype="multipart/form-data" @submit.prevent="CreatePostSubmit" class="form-validate is-alter">
 ...
 <input type="text" class="form-control" name="title" v-model="form.title" >
   ...
   <div class="form-group ">
         <label class="form-label d-block mb-2" for="full-name">Publish </label>
                                    <button type="submit" class="btn d-block ml-auto btn-primary">Add Post</button>
                                </div>
...
CreatePostSubmit(){
 this.$Progress.start()
                let url='/api/auth/site_post_for_create';
let bearer='bearer'+ this.token;
